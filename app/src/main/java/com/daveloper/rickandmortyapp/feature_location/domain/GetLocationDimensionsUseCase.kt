...
/** The [GetLocationDimensionsUseCase] makes a subscription and get all the [Location] Dimensions
 * saved on real time.
 * */
class GetLocationDimensionsUseCase @Inject constructor(
    ...
    operator fun invoke(
        ...
        return try {
            ...
            locationRepository.getLocationDimensionsInRealTime(
            ).map { dimensions ->
                listOf(allValue) + dimensions
            }
        } catch (e: Exception) {
