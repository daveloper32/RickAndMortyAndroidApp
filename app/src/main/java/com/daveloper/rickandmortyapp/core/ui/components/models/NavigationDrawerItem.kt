...
/** Data model descriptor of some item internal data for a Navigation Drawer Component
 ...
 * @param onClick ([Unit]? type) - Lambda function to handle some action when user click on the item.
 * */
